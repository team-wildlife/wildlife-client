...
$('select[name="country"]').on('change', function(event) {
  ...
  $('#gmap').attr('src', `https://maps.googleapis.com/maps/api/staticmap?center=${fullCountryName}&zoom=5&mapTypeControl=false&disableDefaultUI=true&draggable=false&maptype=hybrid&size=640x480&key=AIzaSyDfmioE-Hn7m8RVZakitH5CZjc7-V1uwNY`)
